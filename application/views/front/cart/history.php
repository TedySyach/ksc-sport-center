	                ...
	                <tr>
	                  ...
	                  <td style="text-align:center"><?php echo $history->id_invoice ?></a></td>
										...
										<td style="text-align:center">
											...
											<button type="button" name="status" class="btn btn-danger"><i class="fa fa-remove"></i>KADALUARSA</button>
											<?php } elseif($history->status == '4'){ ?>
											<button type="button" name="status" class="btn btn-danger"><i class="fa fa-remove"></i>BATAL</button>
											<?php } ?>
										</td>
										<td style="text-align:center">
