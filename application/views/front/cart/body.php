...
<div class="container">
	<div class="row">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var durasiInputs = document.querySelectorAll('.durasi');
        
            durasiInputs.forEach(function(input) {
                input.addEventListener('input', function() {
                    var durasi = parseInt(this.value, 10);
                    var jamMulai = parseInt(this.closest('tr').querySelector('[name="jam_mulai[]"]').value, 10);
        
                    // Batasan durasi hingga tengah malam (24:00:00)
                    var durasiMax = 24 - jamMulai;
                    if (durasi > durasiMax) {
                        this.value = durasiMax;
                    }
                });
            });
        });
