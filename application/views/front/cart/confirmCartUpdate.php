...
<div class="container">
	<div class="row">
        ...
        <hr>
                ...
                <div class="col-lg-4">
                    ...
                    <form id="customerDetailsForm" >
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control rounded-input" name="nama" value="<?= $users['name']; ?>" readonly required>
                            <?= form_error('nama','<font size="1px" color="red">','</font>') ?>
                        </div>
                        <div class="form-group">
                            <label for="customerEmail">Email:</label>
                            <input type="email" class="form-control rounded-input" name="email" value="<?= $users['email']; ?>" readonly required>
                            <?= form_error('email','<font size="1px" color="red">','</font>') ?>
                        </div>
                        <div class="form-group">
                            <label for="customerPhone">No HP:</label>
                            <input type="tel" class="form-control rounded-input" name="nohp" id="customerPhone" value="<?= $users['phone']; ?>" readonly required>
            ...
            <div class="row ljb" >
                <div class="col-lg-12">
                 <button id="tombolAksi" type="button" class="lanjutBayar2" >Konfirmasi Pesanan</button>
                </div>
            </div>     
		</div>
		
        <script>
            // Fungsi untuk meredirect ke halaman lain saat elemen diklik
            function redirectToOtherPage() {
                window.location.href = '<?= base_url('confirmPesan') ?>'; // Ganti dengan URL halaman lain yang diinginkan
            }
        
            // Mendapatkan elemen dengan kelas lanjutBayar2
            var lanjutBayarButton = document.querySelector('.lanjutBayar2');
        
            // Menambahkan event listener untuk meredirect saat diklik
            lanjutBayarButton.addEventListener('click', redirectToOtherPage);
        </script>
