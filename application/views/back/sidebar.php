<aside class="main-sidebar">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if($this->uri->segment(2)=="Request_member" ){echo "class='active'";} ?>>
        <a href="<?php echo base_url('admin/Request_member') ?>">
          <i class="fa fa-book"></i> <span>Request Member Premium</span>
        </a>
      </li>
      ...
      <li <?php if($this->uri->segment(2)=="report_trx"){echo "class='active'";} ?>>
        <a href="<?php echo base_url('admin/report_trx') ?>">
      ...
      <li <?php if($this->uri->segment(2) == "jam"){echo "class='active'";} ?>>
        <a href='#'><i class='fa fa-list'></i><span> Set Waktu && Harga </span><i class='fa fa-angle-left pull-right'></i></a>
        <ul class='treeview-menu'>
          <li <?php if($this->uri->segment(2) == "jam" && $this->uri->segment(3) == ""){echo "class='active'";} ?>><a href='<?php echo base_url('admin/jam') ?>'><i class='fa fa-circle-o'></i> Set Waktu && Harga List </a></li>
        </ul>
      </li>
