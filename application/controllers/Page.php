...
class Page extends CI_Controller {
	...
	function __construct()
  {
	...
	public function tes(){
		...
		$this->email->to('olihsolihudin34@gmail.com');
	...
	public function cobaEmail() {
		$this->Sendemail('olihsolih213@gmail.com');
	}
	...
	public function Sendemail($email) {   
		try {
			...
			$this->email->from('admin.edc@bni.co.id', 'bni.co.id');
	
			// Email penerima
			$this->email->to($email); // Ganti dengan email tujuan
	
			// Subject email
			$this->email->subject('Selamat Datang di Layanan Kami!');
	
			// Isi email
			$message = 'Halo [Nama Penerima],

			Kami ingin mengucapkan selamat datang kepada Anda di komunitas kami! Terima kasih telah bergabung dan menjadi bagian dari kami.
			
			Kami senang bisa menyambut Anda di platform kami yang baru. Kami berkomitmen untuk memberikan pengalaman terbaik kepada Anda.
			
			Jangan ragu untuk menjelajahi layanan kami dan jadilah bagian dari diskusi yang menarik. Kami berharap Anda menikmati setiap momen di sini.
			
			Jika Anda memiliki pertanyaan atau butuh bantuan, jangan sungkan untuk menghubungi kami melalui email ini. Kami siap membantu Anda.
			
			Terima kasih sekali lagi atas kepercayaan Anda kepada kami.
